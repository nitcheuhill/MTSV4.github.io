...
document.getElementById('loginForm').addEventListener('submit', async function (event) {
  ...
  const q = query(collection(db, "admin"), where("email", "==", formData.email), where("password", "==", formData.password));
...
function handleFormSubmit(formId, imageUploadId, imageNameId, imageDescriptionId, collectionName, spinnerId, tableId, filterName) {
  document.getElementById(formId).addEventListener('submit', async function (e) {
    ...
    const imageDescription = document.getElementById(imageDescriptionId).value;
...
handleFormSubmit('imageFormbroderie', 'imageUpload1', 'imageName1', 'imageDescription1', 'broderie', 'spinner1', 'productTable1', 'filter-app');
handleFormSubmit('imageFormimprimerie', 'imageUpload2', 'imageName2', 'imageDescription2', 'imprimerie', 'spinner2', 'productTable2', 'filter-product');
handleFormSubmit('imageFormserigraphie', 'imageUpload3', 'imageName3', 'imageDescription3', 'serigraphie', 'spinner3', 'productTable3', 'filter-books');
handleFormSubmit('imageFormsignaletique', 'imageUpload4', 'imageName4', 'imageDescription4', 'signaletique', 'spinner4', 'productTable4', 'filter-signal');
handleFormSubmit('imageFormtampographie', 'imageUpload5', 'imageName5', 'imageDescription5', 'tampographie', 'spinner5', 'productTable5', 'filter-tampo');
handleFormSubmit('imageFormpackaging', 'imageUpload6', 'imageName6', 'imageDescription6', 'packaging', 'spinner6', 'productTable6', 'filter-branding');